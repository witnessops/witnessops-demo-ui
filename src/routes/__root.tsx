  ...
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#0c0d10" },
      {
        name: "description",
        content:
          "WitnessOps workspace for saved External Exposure reviews, evidence, reports and history.",
      },
    ],
    links: [
          ...
          <Hydrate>
            <TooltipProvider delayDuration={200}>
              ...
              <Toaster
                ...
                toastOptions={{
                  className:
                    "!bg-surface !text-fg !border-border !shadow-[var(--shadow-elevated)]",
                }}
              />
            </TooltipProvider>
          </Hydrate>
